...
export class Main extends Component {
    ...
    render() {
        ...
        for (const [qusai, value] of horneArry.entries()) {
            horneBeastArry.push(<HornedBeast
...
{/* <HornedBeast
    image_url={horneArry[0].image_url}
    title={horneArry[0].title}
    description={horneArry[0].description}
    keyword={horneArry[0].keyword}
    horns={horneArry[0].horns} /> */}